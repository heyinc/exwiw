...
DO $$ BEGIN CREATE EXTENSION IF NOT EXISTS "btree_gist"; EXCEPTION WHEN feature_not_supported OR invalid_schema_name THEN RAISE WARNING 'exwiw: skipped CREATE EXTENSION btree_gist (SQLSTATE %): %', SQLSTATE, SQLERRM; END $$;
